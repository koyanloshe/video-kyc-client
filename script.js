...
(async function () {
  ...
  const loadFaceApiModels = async () => {
    // Assumes models are served from /models folder.
    await faceapi.nets.ssdMobilenetv1.loadFromUri("/models"); // for face detection
    await faceapi.nets.faceLandmark68Net.loadFromUri("/models"); // 68-point landmarks
    await faceapi.nets.faceRecognitionNet.loadFromUri("/models"); // face descriptor model
